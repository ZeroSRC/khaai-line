      ...
      <div className="px-4 space-y-3">
        ...
        <div className="bg-white rounded-3xl p-4 shadow-[0_2px_16px_rgba(0,0,0,0.07)] space-y-3">
          ...
          <Field label="ชื่อสินค้า" required>
            <input className={inp} placeholder="ชื่อสินค้า" value={name} onChange={(e) => setName(e.target.value)} autoFocus />
          </Field>
          <Field label="SKU / รหัสสินค้า">
            <input className={inp} placeholder="เช่น SKU-001 (ถ้ามี)" value={sku} onChange={(e) => setSku(e.target.value)} />
          </Field>
        </div>
